...
public class GuestbookPortlet extends MVCPortlet {
	...
	private List<Entry> parseEntries (String[] guestbookEntries) {
		...
		for (String entry : guestbookEntries) {
			...
			Entry gbEntry = new Entry(parts[0], parts[1], parts[2], parts[3], parts[4]);
			entries.add(gbEntry);
		}
